...
import net.srirangan.packt.maven.dao.BlogEntryDao;
import net.srirangan.packt.maven.dao.BlogEntryDaoBean;
import net.srirangan.packt.maven.injectionprovider.CurrentUserInjectionProvider;
import net.srirangan.packt.maven.testdata.BlogEntryTestdataBuilder;
